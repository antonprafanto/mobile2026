...
Selamat datang di **Modul 03**! Di modul ini, Anda akan menguasai arsitektur navigasi modern standar industri menggunakan **`go_router`**, mengimplementasikan **Nested Navigation (`StatefulShellRoute`)** untuk mempertahankan state tab aplikasi, mengaktifkan **Deep Linking (App Links & Universal Links)**, hingga membangun sistem formulir interaktif (*Form System*) yang aman, tervalidasi, dan dilengkapi format otomatis (seperti format mata uang Rupiah).
...
|---|---|---|
| **Imperative Navigation (1.0)** | **Buku Tumpukan Kertas Resepsionis** | Anda menumpuk lembaran halaman di atas tumpukan meja (`push`) dan mencabutnya (`pop`). Sangat rapuh ketika pengguna membuka link langsung dari luar (Deep Link) atau me-refresh browser. |
...
## 🔒 5. Route Guards & Otentikasi Dinamis (Redirect Logic)
...
## 🔗 6. Deep Linking (App Links & Universal Links)

<p align="center">
  <img src="images/deep-linking-flow.svg" alt="Alur Deep Linking" width="700">
</p>

### 6.1 Konfigurasi Android App Links
...
## 📝 7. Form System, Formatters, & Input Validation Lanjutan

<p align="center">
  <img src="images/form-lifecycle-focus.svg" alt="Pipeline Input Form" width="700">
</p>

### 7.1 Komponen Form Utama
...
### 7.2 Custom TextInputFormatter: Format Otomatis Mata Uang Rupiah

Pengguna sering kali bingung jika harus mengetik angka manual tanpa titik pemisah ribuan. Mari buat Formatter kustom:
...
## 🛡️ 8. Intersepsi Tombol Back Modern dengan `PopScope`
...
Widget build(BuildContext context) {
  return PopScope(
    ...
    onPopInvokedWithResult: (bool didPop, dynamic result) async {
      if (didPop) return; // Jika sudah di-pop, jangan lakukan apa-apa
      ...
      if (confirmExit == true && context.mounted) {
        Navigator.of(context).pop(); // Tutup layar secara manual
      }
    },
    child: Scaffold(
...
## 💻 9. Hands-on Project: Multi-Step Checkout & Form Wizard App

Mari kita satukan seluruh konsep: **`go_router`**, **`StatefulShellRoute`**, **`PopScope`**, **Format Rupiah**, dan **Validasi Form** ke dalam satu aplikasi nyata:
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Field 3: Nominal Bayar dengan Filter Angka
                TextFormField(
...
## ⚠️ 10. Jebakan Umum (*Common Pitfalls*) & Solusi Kilat
...
- [x] Menguasai Form System: `Form`, `TextFormField`, `FocusNode`, dan `AutovalidateMode`.
