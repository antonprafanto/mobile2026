...
| **04A** | **[Modul 04A: Fondasi State & Provider](modul-04a-fondasi-state-dan-provider/README.md)** | Ephemeral vs App State, ValueNotifier, Provider (ChangeNotifier) | TokoKita Cart & Wishlist with Provider | ✅ **Selesai** |
| **04B** | **[Modul 04B: State Modern Riverpod 2.x](modul-04b-modern-state-riverpod/README.md)** | Riverpod 2+, ConsumerWidget, AsyncValue, Modifiers | TokoKita Live Search & Wishlist Riverpod | ✅ **Selesai** |
