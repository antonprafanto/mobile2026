"""
Generator Slide Pertemuan 02 (Edisi Masterpiece 16 Slide Lengkap & Super Ramah Awam)
...
- FITUR UTAMA: 100% SLIDE PEMBAHASAN DISERTAI KODE NYATA DARTPAD/VS CODE, ANALOGI MEMBUMI, DAN TIPS AWAM.
"""
...
class NeoBrutalistDeckBuilder:
    ...
    def add_concept_with_code(self, tag, title, bullets, code_snippet, filename="latihan.dart", tip=None, tag_color=COLOR_YELLOW):
        slide = self.prs.slides.add_slide(self.blank_layout)
        self._set_canvas_bg(slide)
